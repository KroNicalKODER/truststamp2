...
class UserInfoPage extends Component {
  componentDidMount() {
    const { user, saveUserData } = this.props;

    // Log the user data
    console.log("User Info:", user.pic);
          ...
          <div className="flex justify-between items-center ">
            <div className="flex items-center flex-grow ">
              <img
                src={user.pic}
                alt="Profile"
                className="rounded-full h-14 w-14 object-cover mr-5"
              />
          ...
          <div className="mt-10 flex justify-center relative">
            ...
            <div className="hover-text">
              <div className="flex m-2 flex-row  h-[80%]">
                ...
                <div className="m-2 flex-1 flex-col text-[0.8vw] justify-center text-right">
                  ...
                  <div>
                    ...
                    Aliquam cupiditate, quae provident officia quasi eligendi
                    cum, excepturi repellendus molestiae, vitae sequi ea error
                    nostrum consequuntur optio tenetur modi sunt esse
                    reprehenderit
                  </div>
                </div>
              </div>
              <div className="flex button-container">
                <button
                  className="flex-1 m-2 flex justify-center like-button"
                  style={{ backgroundColor: "transparent" }}
                >
                  Like
                </button>
                <button
                  className="flex-1 m-2 flex justify-center comment-button"
                  style={{ backgroundColor: "transparent" }}
                >
                  Comment
                </button>
                <button
                  className="flex-1 m-2 flex justify-center"
                  style={{ backgroundColor: "transparent" }}
                >
                  Share
                </button>
...
export default connect(mapStateToProps, { saveUserData })(UserInfoPage);
